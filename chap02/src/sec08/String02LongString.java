...
public class String02LongString { // class
	...
	public static void main(String[] args) { // main
		...
		System.out.println("분리된 단어의 갯수 : " + strArr.length);
		...
		// 문제 1. str 데이터 중 "HTML5"라는 단어가 몇번 노출되는지
		...
		for(int i=arrStr.length-1; i >=0; i--) { // int i=arrStr.length-1 는 인덱스는 0부터 시작하기때문에
			System.out.print(arrStr[i]+" ");
		}
		
		System.out.println();
		
		// 문제2. 위의 str 데이터를 모두 역순(space기준)으로
		// resultStr 변수에 저장하여 출력
		
		for(int i=strArr.length-1; i >=0; i--) { // int i=arrStr.length-1 는 인덱스는 0부터 시작하기때문에
