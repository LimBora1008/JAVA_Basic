...
public class BoxingUnBoxingExample2 {
	public static void main(String[] args) {
		// Boxing
		Integer obj1 = new Integer(100); // int값을 받는 생성자
		Integer obj2 = new Integer("200"); // 문자열을 받는 생성자
		// valueOf : 문자열 형식의 int값을 받아서 Integer 타입 객체로 반환함
